// ============ DEMO DATA ============
const CURATORS = [
  { id: 0, name: 'Аникина С.В.',  full: 'Аникина Светлана Вячеславовна', short: 'АС', dot: '#1565C0' },
  { id: 1, name: 'Романова М.П.', full: 'Романова Марина Петровна',       short: 'РМ', dot: '#1A7A3A' },
  { id: 2, name: 'Горбунов В.К.', full: 'Горбунов Виктор Кириллович',     short: 'ГВ', dot: '#6A3FAA' },
];
